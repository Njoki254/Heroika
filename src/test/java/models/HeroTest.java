...
public class HeroTest {
    ...
    /*  @Test
      public void deleteDeletesASpecificPost() throws Exception {
          models.Hero post = setupNewHero();
          models.Hero otherHero = new models.Hero( "Nakia", 30, "agility",  "gullibility");
          post.deleteHero();
          assertEquals(1, models.Hero.getInstances().size()); //one is left
          assertEquals(models.Hero.getInstances().get(2).getId(),2 ); //the one that was deleted has the id of 2. Why do we care?
      }*/
    @Test
